...
<head>
    ...
    <script src="https://kit.fontawesome.com/3d3f7b19ed.js" crossorigin="anonymous"></script>
    {{-- <style>
         .form-select{
                    ...
                    <div class="card shadow border-0  " style="background-color: f8f9fe;">
                        <div class="card-header d-flex justify-content-between align-items-center border-0 bg-white  py-3 px-4 mb-1 ">
                            ...
                            <div class="d-flex align-items-center   column-gap-2 ">
                                <button class="btn btn1 text-white" >View it</button>
                                <button class="btn btn1 text-white" >Login as</button>
                            </div>
                        </div>
                        ...
                        <div class="card-body " style="background-color: #fafafa;">
                            ...
                            <div class="row w-100 my-4 ">
                                <div class="col d-flex justify-content-center">
                                    <button class="btn btn1 p-2 px-4 text-white " >Save</button>
                                </div>
                            </div>
