                            ...
                            <table class="table border-top">
                                ...
                                <tbody class="">
                                    <tr>
                                        ...
                                        <td ><button class="btn btn-success mb-2 me-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">qr_code</span>QR</div></button>  <button class="btn btn-primary mb-2 me-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">border_color</span>Edit</div></button>  <button class="btn btn-danger mb-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">delete</span>Delete</div></button></td>
                                    </tr>
                                    <tr >
                                        <th scope="row" class="text-center  text-secondary"></th>
