        ...
        <nav class="navbar    text-white " style="    background: linear-gradient(87deg, #11cdef 0, #1171ef 100%) !important" >
            ...
            <div  class=" container-fluid">
                ...
                <div class="row w-100 ms-2">
                    ...
                    <h5 class="col-3  align-items-center  d-flex mb-0">Tables </h5>
                    ...
                    <div class="card p-0 shadow border-0  " style="background-color: f8f9fe;">
                        <div class="card-header p-0 border-0 pt-4 py-1  bg-white   " >  
                           <div class="row d-flex  pb-3  justify-content-center   "> 
                            <div class="col-sm-4 col-12 "><h5 class="text-start ms-4 ">Tables management</h5></div> 
                            <div class="col-sm-8 col-12">
                                <div class="d-flex align-items-center justify-content-end column-gap-2  me-4 ">
                                 <a href="/users/tables/addTable" class="btn btn-primary "> ADD new table</a>
                                 <a href="/users/tables/areas"  class="btn btn-primary">Areas</a>
                                </div>
                            ...
                            <table class="table border-top">
                                <thead>
                                    <tr >
                                        ...
                                        <th style="background-color: #F6F9FC; color: #8898AA; text-align: center;" scope="col">SIZE</th>
                                        <th style="background-color: #F6F9FC; color: #8898AA; text-align: center;" scope="col">AREA</th>
                                        <th style="background-color: #F6F9FC; color: #8898AA; text-align: center;" scope="col">ACTIONS</th>
                                    </tr>
                                </thead>
                                <tbody class="">
                                    <tr>
                                        <th scope="row" class="text-center  text-secondary">Table 1</th>
                                        <th scope="row" class="text-center  text-secondary">4</th>
                                        <th scope="row" class="text-center  text-secondary">Indoor</th>
                                        <td ><button class="btn btn-success mb-2 me-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">qr_code</span>QR</div></button>  <a href="/users/tables/editArea"  class="btn btn-primary mb-2 me-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">border_color</span>Edit</div></a>  <button class="btn btn-danger mb-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">delete</span>Delete</div></button></td>
                                    </tr>
                                    <tr>
                                        <th scope="row" class="text-center  text-secondary">Table 2</th>
                                        <th scope="row" class="text-center  text-secondary">5</th>
                                        <th scope="row" class="text-center  text-secondary">Indoor</th>
                                        <td ><button class="btn btn-success mb-2 me-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">qr_code</span>QR</div></button>  <a href="/users/tables/editArea"  class="btn btn-primary mb-2 me-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">border_color</span>Edit</div></a>  <button class="btn btn-danger mb-2"><div class="d-flex align-items-center"><span class="material-symbols-outlined">delete</span>Delete</div></button></td>
                                    </tr>
                                </tbody>
